...
x_train, x_test, y_train, y_test = train_test_split(x_raw, y_numbers, shuffle=False, train_size = 0.4)
x_train_n, x_test_n, y_train_n, y_test_n = train_test_split(x_norm, y_numbers, shuffle=False, train_size = 0.4)
...
print("-------Sample SkLearn model: MLP---------")
my_model = neural_network.MLPClassifier(hidden_layer_sizes=(300, 100), max_iter=1000)
...
print("-------Sample SkLearn model: Bagging Decision Tree ---------")
...
print("-------Sample SkLearn model: Decision Tree Norm---------")
...
# Perform the search
my_tuned_tree = GridSearchCV(tree.MLPClassifier(hidden_layer_sizes=(300, 100), max_iter=1000), \
                                param_grid, cv=cv_folds, verbose = 2, \
                            return_train_score=True, n_jobs = -1)
my_tuned_tree.fit(x_train_n, y_train_n)
